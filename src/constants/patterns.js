export const BASIC_EIGHT_BEAT_LIBRARY = {
  straight: [
    ...
    { hand: ['H', '', 'H', '', 'HS', '', 'H', '', 'H', '', 'H', '', 'HS', '', 'H', ''], kick: [0, 4, 10] },
    { hand: ['H', '', 'H', '', 'HS', '', 'H', '', 'H', '', 'H', '', 'HS', '', 'H', ''], kick: [0, 2, 8, 10] },
    { hand: ['H', '', 'H', '', 'HS', '', 'H', '', 'H', '', 'H', '', 'HS', '', 'H', ''], kick: [0, 2, 10] },
    { hand: ['H', '', 'H', '', 'HS', '', 'H', '', 'H', '', 'H', '', 'HS', '', 'H', ''], kick: [0, 6, 8, 10] },
    { hand: ['H', '', 'H', '', 'HS', '', 'H', '', 'H', '', 'H', '', 'HS', '', 'H', ''], kick: [0, 4, 8, 10] },
    { hand: ['H', '', 'H', '', 'HS', '', 'H', '', 'H', '', 'H', '', 'HS', '', 'H', ''], kick: [0, 2, 6, 10] },
    { hand: ['H', '', 'H', '', 'HS', '', 'H', '', 'H', '', 'H', '', 'HS', '', 'H', ''], kick: [0, 2, 4, 10] },
  ],
  syncopated: [
    { hand: ['H', '', 'H', '', 'HS', '', 'H', '', 'H', '', 'H', '', 'HS', '', 'H', ''], kick: [0, 6, 10] },
    ...
    { hand: ['H', '', 'H', '', 'HS', '', 'H', '', 'H', '', 'H', '', 'HS', '', 'H', ''], kick: [0, 2, 6, 10] },
    { hand: ['H', '', 'H', '', 'HS', '', 'H', '', 'H', '', 'H', '', 'HS', '', 'H', ''], kick: [0, 2, 8, 10] },
    { hand: ['H', '', 'H', '', 'HS', '', 'H', '', 'H', '', 'H', '', 'HS', '', 'H', ''], kick: [0, 5, 10] },
    { hand: ['H', '', 'H', '', 'HS', '', 'H', '', 'H', '', 'H', '', 'HS', '', 'H', ''], kick: [0, 2, 5, 10] },
    { hand: ['H', '', 'H', '', 'HS', '', 'H', '', 'H', '', 'H', '', 'HS', '', 'H', ''], kick: [0, 6, 9, 10] },
    { hand: ['H', '', 'H', '', 'HS', '', 'H', '', 'H', '', 'H', '', 'HS', '', 'H', ''], kick: [0, 2, 6, 9, 10] },
  ],
  ride: [
  ...
  shake: [
    { hand: ['H', '', 'H', '', 'HS', '', 'H', 'S', 'H', 'S', 'H', '', 'HS', '', 'H', ''], kick: [0, 10] },
    { hand: ['H', '', 'H', '', 'HS', '', 'H', 'S', 'H', 'S', 'H', '', 'HS', '', 'H', ''], kick: [0, 8, 10] },
    { hand: ['H', '', 'H', '', 'HS', '', 'H', 'S', 'H', 'S', 'H', '', 'HS', '', 'H', ''], kick: [0, 10, 14] },
    { hand: ['H', '', 'H', '', 'HS', '', 'H', 'S', 'H', 'S', 'H', '', 'HS', '', 'H', ''], kick: [0, 6, 10] },
  ],
  dance: [
    { hand: ['', '', 'H', '', 'HS', '', 'H', '', '', '', 'H', '', 'HS', '', 'H', ''], kick: [0, 4, 8, 12] },
    { hand: ['', '', 'H', '', 'HS', '', 'H', '', '', '', 'H', '', 'HS', '', 'H', ''], kick: [0, 4, 8, 10, 12] },
    { hand: ['', '', 'H', '', 'HS', '', 'H', '', '', '', 'H', '', 'HS', '', 'H', ''], kick: [0, 4, 8, 12, 14] },
    { hand: ['', '', 'H', '', 'HS', '', 'H', '', '', '', 'H', '', 'HS', '', 'H', ''], kick: [0, 4, 8, 9, 12] },
  ],
  soca: [
    { hand: ['', '', 'H', '', 'HS', '', 'H', '', '', '', 'H', '', 'HS', '', 'H', ''], kick: [0, 3, 8, 11] },
    { hand: ['', '', 'H', '', 'HS', '', 'H', '', '', '', 'H', '', 'HS', '', 'H', ''], kick: [0, 3, 6, 8, 11] },
    { hand: ['', '', 'H', '', 'HS', '', 'H', '', '', '', 'H', '', 'HS', '', 'H', ''], kick: [0, 3, 8, 10, 11] },
    { hand: ['', '', 'H', '', 'HS', '', 'H', '', '', '', 'H', '', 'HS', '', 'H', ''], kick: [0, 2, 3, 8, 11] },
  ],
}
...
export const GENRE_GROOVE_LIBRARY = {
  ...
  blues: [
    { hand: ['H', '', '', 'H', 'HS', '', '', 'H', 'H', '', '', 'H', 'HS', '', '', 'H'], kick: [0, 8] },
    { hand: ['H', '', '', 'H', 'HS', '', '', 'H', 'H', '', '', 'H', 'HS', '', '', 'H'], kick: [0, 4, 8] },
    { hand: ['H', '', '', 'H', 'HS', '', '', 'H', 'H', '', '', 'H', 'HS', '', '', 'H'], kick: [0, 8, 12] },
    { hand: ['H', '', '', 'H', 'HS', '', '', 'H', 'H', '', '', 'H', 'HS', '', '', 'H'], kick: [0, 3, 8] },
    { hand: ['H', '', '', 'H', 'HS', '', '', 'H', 'H', '', '', 'H', 'HS', '', '', 'H'], kick: [0, 4, 8, 12] },
    { hand: ['H', '', '', 'H', 'HS', '', '', 'H', 'H', '', '', 'H', 'HS', '', '', 'H'], kick: [0, 4, 6, 8] },
    { hand: ['R', '', '', 'R', 'RS', '', '', 'R', 'R', '', '', 'R', 'RS', '', '', 'R'], kick: [0, 8] },
    { hand: ['R', '', '', 'R', 'RS', '', '', 'R', 'R', '', '', 'R', 'RS', '', '', 'R'], kick: [0, 4, 8] },
  ],
  jazz: [],
}
